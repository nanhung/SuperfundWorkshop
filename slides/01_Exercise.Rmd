...
# 2 Example 2: Three-compartment PBPK model 1,3-butadiene


## Exercise 2.1:
Run Butadiene-PBPK model under 2 ppm exposure for 20 minutes and plot the time-course of exhaled air concentration from 0 to 60 minutes.

```{r}
out <- mcsim(model = "models/butadiene.model", input = "inputs/butadiene.in")
```
