...
```{r}
IngDose <- 4.02
Fgutabs <- tail(ffpk.mcmc.out$Fgutabs.1., 1)
kgutabs <- tail(ffpk.mcmc.out$kgutabs.1., 1)
kelim <- tail(ffpk.mcmc.out$kelim.1., 1)	
Vdist <- tail(ffpk.mcmc.out$Vdist.1., 1)
MW <- 180.164

t <- c(.01,  0.25,  0.57, 1.12,  2.02,  3.82,  5.10,  7.03,  9.05, 12.12, 24.37)
