...
.pull-right[
.code75[
```{r fig.height=5.0, dev='svg', eval=T}
D_0 <- 10
t <- seq(0.01, 10.01, 1)
k_e <- 0.5
D_t <- D_0*exp(-k_e*t) 
...
$\mathrm{C}=\frac{\mathrm{F} \cdot \mathrm{D} \cdot \mathrm{k}_{\mathrm{a}}}{\mathrm{V}\left(\mathrm{k}_{\mathrm{a}}-\mathrm{k}_{\mathrm{e}}\right)} \cdot\left(\mathrm{e}^{-\mathrm{k}_{\mathrm{e}} \mathrm{t}}-\mathrm{e}^{-\mathrm{k}_{\mathrm{a}} \cdot \mathrm{t}}\right)$

**Time of maximum concentration**

$\mathrm{t}_{\max }=\frac{\ln \left(\frac{\mathrm{k}_{\mathrm{a}}}{\mathrm{k}_{\mathrm{e}}}\right)}{\left(\mathrm{k}_{\mathrm{a}}-\mathrm{k}_{\mathrm{e}}\right)}$
...
$\mathrm{C}=\frac{\mathrm{F} \cdot \mathrm{D} \cdot \mathrm{k}_{\mathrm{a}}}{\mathrm{V}\left(\mathrm{k}_{\mathrm{a}}-\mathrm{k}_{\mathrm{e}}\right)} \cdot\left(\frac{\mathrm{e}^{-\mathrm{k}_{\mathrm{e}} \mathrm{t}}}{\left(1-\mathrm{e}^{-\mathrm{k}_{\mathrm{e}} \tau}\right)}-\frac{\mathrm{e}^{-\mathrm{k}_{\mathrm{a}} \cdot \mathrm{t}}}{\left(1-\mathrm{e}^{-\mathrm{k}_{\mathrm{a}} \tau}\right)}\right)$
...
$C_{ss}=\frac{\mathrm{F} \cdot \mathrm{D}}{\mathrm{CL} \cdot \tau}$

$CL = \frac{Dose \cdot F}{AUC} = \frac{k_e}{V}$ 
...
```{r}
C_inh <- approxfun(x = c(0, 100), y=c(10,0), method = "constant", f = 0, rule = 2) 
```

```{r fig.height=4.5, dev='svg', eval=T}
...
.pull-right[
![:scale 60%](https://ars.els-cdn.com/content/image/1-s2.0-S027323000600095X-gr3.jpg)
]
...
.center[![:scale 70%](https://i.ibb.co/c6ht46y/Screenshot-from-2019-11-28-15-10-21.png)]
...
![:scale 70%](https://i.ibb.co/y592vn2/Screenshot-from-2019-11-28-15-17-34.png)
...
![](https://i.ibb.co/RNxBfN5/GNU-MCSIm-Workflow.png)
...
- Model construction (oral intake)
...
- Advance practice (inhalation exposure)
