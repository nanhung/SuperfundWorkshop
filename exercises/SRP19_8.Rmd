...
for (iteration in 1:1000){
  parameters["BDM"] <- rnorm()         # N(73, 7.3)
  parameters["Flow_pul"] <- rnorm()    # N(5, 0.5)
  parameters["PC_art"] <- rnorm()      # N(2, 0.2)
  parameters["Kmetwp"] <- rnorm()      # N(0.25, 0.025)
  
  # We focus on time at 24 hour
  times <- c(0, 1440)

  # Integrate
  tmp <- ode(times = , func = , y=, parms=)
