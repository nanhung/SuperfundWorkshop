---
title: "Exercise 1.4: Developing the PBPK model"
...
- Exposure: Continuous exposure of the 10 ppm 1,3-butadiene for 2 hour.
...
```{r}
C_inh <- approxfun(x = , y= , method = "constant", f = 0, rule = 2) 
```
